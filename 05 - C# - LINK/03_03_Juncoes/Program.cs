...
namespace _03_03_Juncoes 
{
    class Program
    {
        private static List<Produto> produtos = new List<Produto>
        {
            ...
            new Produto { Nome = "Monitor", Preco = 8000, Categoria = "Informatica"},
            new Produto { Nome = "Cama", Preco = 8000, Categoria = "Moveis"},
            new Produto { Nome = "Armario", Preco = 8000, Categoria = "Moveis"}
        };
